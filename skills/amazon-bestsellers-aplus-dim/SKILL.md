...
本 skill 目录下提供了图片爬虫工具：

```
.claude/skills/amazon-bestsellers-top50-aplus-dim/fetch_aplus_images.py
```

### 使用方法

```bash
python fetch_aplus_images.py \
  --chunks-dir <out_dir路径> \
  --top-n 5 \
  --output-dir <输出目录>
```
